Marvin.window.CommentReview = function(config) {
    config = config || {};
    ...
    Ext.applyIf(config,{
        ...
        ,fields: [{
            ...
            ,items: [{
                ...
                ,items: [{
                    xtype: 'textarea'
                    ,fieldLabel: _('marvin.comment.text')
                    ,name: 'text'
                    ,id: this.ident+'-text'
                    ,anchor: '100%'
                    ,grow: true
                ...
                ,items: [{
                    xtype: 'marvin-combo-comment-state'
                    ,fieldLabel: _('marvin.comment.state')
                    ,hiddenName: 'state'
                    ,anchor: '100%'
                    ,id: this.ident+'-state'
                },{
                    xtype: 'statictextfield'
                    ,fieldLabel: _('marvin.comment.authors_name')
                    ,name: 'authors_name'
                    ,id: this.ident+'-authors_name'
                    ,anchor: '100%'
                },{
                    xtype: 'statictextfield'
                    ,fieldLabel: _('marvin.comment.authors_email')
                    ,name: 'authors_email'
    ...
    Marvin.window.CommentReview.superclass.constructor.call(this,config);
...
Ext.extend(Marvin.window.CommentReview,MODx.Window,{
...
Ext.reg('marvin-window-comment-review',Marvin.window.CommentReview);
